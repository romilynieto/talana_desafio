class Util:
    ...
    def decidir_iniciador(self, jugador1, jugador2):
        # Obtener las combinaciones de botones de ambos jugadores
        comb_jugador1 = self.combine_botones(jugador1.datos_comb["movimientos"], jugador1.datos_comb["golpes"])
        comb_jugador2 = self.combine_botones(jugador2.datos_comb["movimientos"], jugador2.datos_comb["golpes"])

        # Calcular el número de botones y golpes de cada jugador
        botones_jugador1 = self.contar_botones(comb_jugador1[0])
        botones_jugador2 = self.contar_botones(comb_jugador2[0])
        golpes_jugador1 = self.contar_golpes(comb_jugador1[0])
        golpes_jugador2 = self.contar_golpes(comb_jugador2[0])
